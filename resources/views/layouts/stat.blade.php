...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('admin/assets/images/2.png') }}">
    <title>Stat Diary BEM SV UNDIP 2021</title>
    <meta charset="UTF-8">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    <li class="nav-item">
                        <a href="/statdiary" class="nav-link smoothScroll">Beranda</a>
                    </li>

                    <li class="nav-item">
                        <a href="/statdiary/database" class="nav-link smoothScroll">Database</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="/statdiary/survey" class="nav-link smoothScroll">Hasil Survey</a>
                    </li>
