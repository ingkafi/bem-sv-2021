                ...
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="name" id="name" class="form-control" value="{{ $user->name }}" style="text-transform:uppercase">
                            @error('name')
                        ...
                        <div style="float: right">
                            ...
                            <a href="/admin/kelola/user" class="btn waves-effect waves-light btn-rounded btn-danger">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
