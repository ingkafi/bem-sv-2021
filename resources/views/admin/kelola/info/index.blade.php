    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">Kelola<a href="/info"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-outline-info">Lihat
                            Halaman</button> </a></h2>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <h3 class="card-title">Tabel Informasi <a href="/admin/kelola/info/create"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-success">Tambah
                            ...
                            <table class="table no-wrap v-middle mb-0 table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th><img style="width: 70px; height:70px ;object-fit: cover;" src="{{ asset('uploads/informasi/' . $row->file_path) }}" class="img-fluid rounded-circle">
                                        </th>
                                        ...
                                        @if ($row->status == '1')
                                        <td>
                                            <a href="/admin/kelola/info/{{ $row->id }}/hide">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="/admin/kelola/info/{{ $row->id }}/delete" id="lineitem">
