                            ...
                            <table class="table no-wrap v-middle mb-0 table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <th><img style="width: 70px; height:70px ;object-fit: cover;" src="{{ asset('uploads/gambar/' . $file) }}" class="img-fluid rounded-circle">
                                        </th>
                                        ...
                                        <td>
                                            <a href="/admin/kelola/info/{{ $row->id }}/show">
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success">Lihat</button>
                                            </a>
                                            ...
                                            <button type="button" data-toggle="modal" data-target="#danger-header-modal" data-item="{{ $row->id }}" class="btn waves-effect waves-light btn-rounded btn-outline-danger delete">Hapus</button>
                                        </td>
