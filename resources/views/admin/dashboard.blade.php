                        ...
                        <div class="card-body">
                            <div class="text-success" style="text-align:center;"><i
                                ...
                                <div class="d-inline-flex align-items-center">
                                    <span
                                        class="bg-success badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none">Tampilan
                                        Web</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        ...
                                        <span
                                            class="bg-success badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none">Informasi</span>
                                    </div>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        ...
                                        <span
                                            class="bg-success badge font-18 text-white font-weight-medium badge-pill ml-2 d-lg-block d-md-none">User</span>
                                    </div>
                                    <h6 class=" text-muted font-weight-normal mb-0 w-100 text-truncate"
                                        style="font-size:20px">
                                        Lihat Data</h6>
            ...
            <div class="card-group">
                                ...
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        ...
                                        <span
                                            ...
                                            style="background-color: #4fc1e9">Program Kerja</span>
                                    </div>
                                    <h6 class=" text-muted font-weight-normal mb-0 w-100 text-truncate"
                                        style="font-size:20px">
                                        Lihat Data</h6>
                ...
                <div class="card border-right">
                    <a href="/admin/bem/struktur">
                        <div class="card-body">
                            <div style="color: #4fc1e9; text-align:center;"><i style="width: 70px;height: 70px;"
                                    data-feather="users"></i>
                                <div class="d-inline-flex align-items-center">
                                    <span
                                        class="badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none"
                                        style="background-color: #4fc1e9">Struktur</span>
                                </div>
                            </div>
                        </div>
                    </a>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        ...
                                        <span
                                            class="badge font-18 text-white font-weight-medium badge-pill ml-2 d-lg-block d-md-none"
                                            style="background-color: #4fc1e9">Aspirasi</span>
                                    </div>
                                    <h6 class=" text-muted font-weight-normal mb-0 w-100 text-truncate"
                                        style="font-size:20px">
                                        Lihat Data</h6>
            ...
            <div class="card-group">
                <div class="card border-right">
                    <a href="/admin/statistik/struktur">
                        <div class="card-body">
                            <div style="color: #d5a3e7; text-align:center;"><i style="width: 70px;height: 70px;"
                                    data-feather="users"></i>
                                <div class="d-inline-flex align-items-center">
                                    <span
                                        class="badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none"
                                        style="background-color: #d5a3e7">Struktur</span>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="/admin/statistik/buletin">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h1 class="text-dark font-weight-medium">{{ $buletin }}</h1>
                                        <span
                                            class="badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none"
                                            style="background-color: #d5a3e7">Buletin</span>
                                    </div>
                                    <h6 class=" text-muted font-weight-normal mb-0 w-100 text-truncate"
                                        style="font-size:20px">
                                        Lihat Data</h6>
                    ...
                    <a href="/admin/statistik/survei">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h1 class="text-dark font-weight-medium">{{ $survei }}</h1>
                                        <span
                                            class="badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none"
                                            style="background-color: #d5a3e7">Survey</span>
                                    </div>
                                    <h6 class=" text-muted font-weight-normal mb-0 w-100 text-truncate"
                                        style="font-size:20px">
                                        Lihat Data</h6>
                        ...
                        <div class="card-body">
                            <div style="color: #d5a3e7; text-align:center;"><i style="width: 70px;height: 70px;"
                                ...
                                <div class="d-inline-flex align-items-center">
                                    <span
                                        class="badge font-18 text-white font-weight-medium badge-pill ml-2  d-lg-block d-md-none"
                                        style="background-color: #d5a3e7">Database</span>
                                </div>
                            </div>
                        </div>
                    </a>
