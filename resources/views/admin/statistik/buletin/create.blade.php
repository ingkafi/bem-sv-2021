...
<div class="page-wrapper">
                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="/kelola/informasi" class="text-muted"> Bicara Data</a>
                            </li>
    ...
    <div class="container-fluid">
        <form action="/admin/statistik/buletin/store" method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
