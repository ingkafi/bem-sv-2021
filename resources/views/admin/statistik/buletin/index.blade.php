    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">Biro Statistik <a href="/statdiary/bicara-data">
                        <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-outline-info">Lihat
                            Halaman</button> </a></h2>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a class="text-muted">Bicara Data</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <h3 class="card-title">Tabel Bicara Data <a href="/admin/statistik/buletin/create"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-success">Tambah
                                        Bicara Data</button> </a></h3>
                        </div>
                            ...
                            <table class="table no-wrap v-middle mb-0 table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th><img style="width: 70px; height:70px ;object-fit: cover;" src="{{ asset('uploads/buletin/' . $row->gambar) }}" class="img-fluid rounded-circle">
                                        </th>
                                        <td class="">
                                            <div class=" d-flex align-items-center">
                                                <div class="">
                                                    ...
                                                    <a href="{{ $row->link }}"><span class="text-muted font-14" style="text-decoration: underline">{{ substr($row->link, 0, 20) }}...</span></a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class=" font-weight-medium text-success">
                                            <button type="button" disabled class="btn waves-effect waves-light btn-sm btn-rounded btn-success">
                                                Data Selesai Diproses</button>
                                        </td>
                                        <td>
                                            <a href="/admin/statistik/buletin/{{ $row->id }}/hide">
                                            ...
                                            <a href="/admin/statistik/buletin/{{ $row->id }}/edit">
                                        ...
                                        @elseif ($row->status == '0')
                                        <td class=" font-weight-medium text-success">
                                            <button type="button" disabled class="btn waves-effect waves-light btn-sm btn-rounded btn-secondary">
                                                Data Masih Diproses</button>
                                        </td>
                                        <td>
                                            <a href="/admin/statistik/buletin/{{ $row->id }}/show">
                                            ...
                                            <button type="button" data-toggle="modal" data-target="#danger-header-modal" data-item="{{ $row->id }}" class="btn waves-effect waves-light btn-rounded btn-danger delete"><i data-feather="trash" class="feather-icon"></i></button>
                                        </td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h5 class="mt-0">Buletin akan terhapus
                                                        </h5>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="/admin/statistik/buletin/{{ $row->id }}/delete" id="lineitem">
                                        ...
                                        <script>
                                            $(document).on("click", ".delete", function() {
                                                ...
                                                $("#lineitem").attr("href",
                                                    "/admin/statistik/buletin/" + id + "/delete")
                                            });
                                        </script>
                                        @endif
                                        </td>
