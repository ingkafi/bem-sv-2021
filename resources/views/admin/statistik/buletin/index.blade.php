                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <h3 class="card-title">Tabel Buletin <a href="/admin/statistik/database/create"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-success">Tambah
                                        Buletin</button> </a></h3>
                        </div>
                            ...
                            <table class="table no-wrap v-middle mb-0 table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @elseif ($row->status == '0')
                                        <td class=" font-weight-medium text-success">
                                            <button type="button" class="btn waves-effect waves-light btn-sm btn-rounded btn-danger">
