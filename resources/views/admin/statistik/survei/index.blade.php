                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <h3 class="card-title">Tabel Survei <a href="/admin/statistik/survei/create"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-success">Tambah
                                        Survei</button> </a></h3>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" font-weight-medium text-success">
                                            <button type="button" class="btn waves-effect waves-light btn-sm btn-rounded btn-success">
                                                {{ $surveis->status }}</button>
                                        </td>
                                        <td>
                                            <a href="">
                                                <button type="button" class="btn waves-effect waves-light btn-rounded btn-outline-success" title="Publish"><i data-feather="check" class="feather-icon"></i></button>
                                            </a>
                                            <a href="">
                                            ...
                                            <a href="/admin/statistik/survei/{{ $surveis->id }}/edit">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="/admin/statistik/survei/{{ $surveis->id }}/delete" id="lineitem">
                                        ...
                                        <script>
                                            $(document).on("click", ".delete", function() {
                                                ...
                                                $("#lineitem").attr("href",
                                                    "/admin/statistik/survei/{{ $surveis->id }}/delete")
                                            });
                                        </script>
                                        </td>
                                    </tr>
