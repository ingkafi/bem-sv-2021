...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <form action="/admin/statistik/survei/{{ $surveis->id }}/update" method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="row">
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="judul" id="judul" class="form-control" value="{{ $surveis->judul }}">
                            @error('judul')
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="3" name="isi" id="isi">{{ $surveis->isi }}</textarea>
                            @error('isi')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="link" id="link" value="{{ $surveis->link }}">
                            @error('link')
                        ...
                        <div style="float: right">
                            ...
                            <a href="/admin/kelola/info" class="btn waves-effect waves-light btn-rounded btn-danger">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
