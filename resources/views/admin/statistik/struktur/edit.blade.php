        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                <div class="" style="display: block;margin: auto;"><img id=" myImg" style="object-fit: cover;"
                        src="{{ asset('uploads/statisticdiary/' . $strukturs->foto) }}" alt="{{ $strukturs->nama }}"
                        width="300" height="auto" />
                </div>
            </div>
            <br>
            <form action="/admin/statistik/struktur/{{ $strukturs->id }}/update" method="post"
