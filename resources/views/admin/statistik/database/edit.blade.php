...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <form action="/admin/statistik/database/{{ $databases->id }}/update" method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="row">
                <div class="card" style="width: 100%">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="judul" id="judul" class="form-control" value="{{ $databases->judul }}">
                            @error('judul')
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="link" id="link" value="{{ $databases->link }}">
                            @error('link')
