            ...
            <div class="row">
                    ...
                    <form action="/admin/statistik/database/updatedba" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" name="prodi" id="prodi" value="{{ $database_angkas->prodi }} " class="form-control">
                                @error('prodi')
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="mahasiswa" id="mahasiswa" placeholder="" value="{{ $database_angkas->mahasiswa }}" class="form-control">
                            @error('mahasiswa')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="dosen" id="dosen" placeholder="" value="{{ $database_angkas->dosen }}" class="form-control">
                            @error('dosen')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="himpunan" id="himpunan" placeholder="" value="{{ $database_angkas->himpunan }}" class="form-control">
                            @error('himpunan')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="ukm" id="ukm" placeholder="" value="{{ $database_angkas->ukm }}" class="form-control">
                            @error('ukm')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <h3 class="card-title">Tabel Excel <a href="/admin/statistik/database/create"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-success">Tambah
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" data-toggle="modal" data-target="#danger-header-modal" data-item="{{ $databases->id }}" class="btn waves-effect waves-light btn-rounded btn-outline-danger delete">Hapus</button>
                                        </td>
                                        <div id="danger-header-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="danger-header-modalLabel" aria-hidden="true" style="text-align: center">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="/admin/statistik/database/{{ $databases->id }}/delete" id="lineitem">
