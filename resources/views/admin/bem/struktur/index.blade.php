                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table no-wrap v-middle mb-0" id="myTable">
                                ...
                                <tbody>
                                    <tr>@foreach ($strukturs as $strukturs)
                                        <td>{{ $loop->iteration }}</td>
                                        <th><img style="width: 70px; height:70px ;object-fit: cover;" src="{{ asset('uploads/struktur/'.$strukturs->gambar) }}" class="img-fluid rounded-circle">
                                        </th>
                                        <td class="">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="/admin/bem/struktur/{{ $strukturs->id }}/delete" id="lineitem">
