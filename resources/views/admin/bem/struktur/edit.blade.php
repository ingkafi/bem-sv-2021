                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                <li class="breadcrumb-item"><a href="/bem/struktur" class="text-muted">Struktur
                                        Organisasi</a>
                                </li>
        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center">
                <div class="" style="display: block;margin: auto;"><img id=" myImg" style="object-fit: cover;"
                        src="{{ asset('uploads/struktur/' . $strukturs->gambar) }}" alt="{{ $strukturs->bidang }}"
                        width="300" height="auto" />
                </div>
            </div>
            <br>
            <form action="/admin/bem/struktur/{{ $strukturs->id }}/update" method="post" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <div class="row">
                    <div class="card" style="width: 100%">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="{{ $kabinet->nama }}" readonly="readonly">
                            </div>
                            <h4 class="card-title">Bidang</h4>
                            <div class="form-group">
                                <select class="form-control" id="bidang" name="bidang">
                                    <option selected disabled>Pilih Bidang</option>
                                    @if ($strukturs->bidang == 'Biro Statistik')
                                    ...
                                    @endif
                                    @if ($strukturs->bidang == 'Biro Media Informasi')
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Biro Administratif')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                    ...
                                    @if ($strukturs->bidang == 'K&PSDM')
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Harmonisasi Kampus')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Kesejahteraan Mahasiswa')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Minat dan Bakat')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Riset dan Keilmuan')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Ekonomi Kreatif')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Sosial Masyarakat')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Sosial Politik')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
                                        ...
                                        <option value="Hubungan Masyarakat">Hubungan Masyarakat</option>
                                    @endif
                                    @if ($strukturs->bidang == 'Hubungan Masyarakat')
                                        <option value="Biro Statistik">Biro Statistik</option>
                                        <option value="Biro Media Informasi">Biro Media Informasi</option>
                                        <option value="Biro Administratif">Biro Administratif</option>
                                        <option value="K&PSDM">K&PSDM</option>
