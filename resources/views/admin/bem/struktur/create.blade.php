...
@section('content')
    <div class="page-wrapper">
                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                ...
                                <li class="breadcrumb-item text-muted active" aria-current="page">{{ $kabinet->nama }}
        ...
        <div class="container-fluid">
            <form action="/admin/bem/struktur/{{ $kabinet->tahun }}/store" method="post" enctype="multipart/form-data">
                @method('patch')
                @csrf
                <div class="row">
                    <div class="card" style="width: 100%">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select class="form-control" id="kategori" name="bidang">
