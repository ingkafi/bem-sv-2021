                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-4">
                            <h3 class="card-title">Tabel Program Kerja <a href="/admin/bem/program/create"> <button type="button" class="btn waves-effect btn-sm waves-light btn-rounded btn-success">Tambah
                            ...
                            <table class="table no-wrap v-middle mb-0 table-hover" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th><img style="width: 70px; height:70px ;object-fit: cover;" src=" {{ asset('uploads/proker/'.$proker->gambar) }} " class="img-fluid rounded-circle">
                                        </th>
                                        <td class="px-2 py-4">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    ...
                                                    <span class="text-muted font-14">{{ $proker->keterangan }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="/admin/bem/program/{{ $proker->id }}/edit">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="/admin/bem/program/{{ $proker->id }}/delete" id="lineitem">
                                        ...
                                        <script>
                                            $(document).on("click", ".delete", function() {
                                                ...
                                                $("#lineitem").attr("href",
                                                    "/admin/bem/program/{{ $proker->id }}/delete")
                                            });
                                        </script>
                                    </tr>
                                    @endforeach
