        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto col-12">
                <div class="hero-text mt-5 text-center">
                    <h1 data-aos="fade-up" data-aos-delay="500" style="color: #ffbc12">SURVEY</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-12 text-center">
                <h2 data-aos="fade-up" data-aos-delay="200">Survei Terkini</h2>
                <h3 data-aos="fade-up" data-aos-delay="200">Geser untuk melihat survei lainnya</h3>
                <br>
            </div>
            <br><br>
            <div class="row">
                    ...
                    <div class="row mx-auto my-auto">
                        <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
                                ...
                                <div class="carousel-item active">
                                    <div class="col-md-4">
                                        <div class="card card-body" style="height: 550px">
                                            ...
                                            <img class="img-fluid" alt="100%x280" style="height: 300px; width:300px;object-fit: cover;" src="{{ asset('uploads/survei/' . $survei1->gambar) }}">
                                            <?php
                                            ...
                                            ?>
                                            <div class="card-body">
                                                <h3 class="card-title">{{ $survei1->judul }}</h3>
                                                <p class="card-text">{{ date('j', strtotime($survei1->created_at)) }}
                                                    {{ $monthName }}
                                                    {{ date('Y', strtotime($survei1->created_at)) }}
                                                </p>
                                ...
                                <div class="carousel-item">
                                    <div class="col-md-4">
                                        <div class="card card-body" style="height: 550px">
                                            ...
                                            <img class="img-fluid" alt="100%x280" style="height: 300px; width:300px;object-fit: cover;" src="{{ asset('uploads/survei/' . $row->gambar) }}">
                                            <?php
                            ...
                            <a class="carousel-control-prev w-auto" href="#recipeCarousel" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon bg-info border border-info rounded-circle" aria-hidden="true"></span>
                            </a>
                            <a class="carousel-control-next w-auto" href="#recipeCarousel" role="button" data-slide="next">
                                <span class="carousel-control-next-icon bg-info border border-info rounded-circle" aria-hidden="true"></span>
                            </a>
                        </div>
                    </div>
                </div>
