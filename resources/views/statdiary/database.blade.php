    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-4 text-center">
                ...
                <h1 class="mb-1" data-aos="fade-up" data-aos-delay="200"> {{ $dba->prodi }}</h1>
            </div>
            <div class="col-lg-4 col-4 text-center">
                <h4 data-aos="fade-up">Mahasiswa</h4>
                <h1 class="mb-1" data-aos="fade-up" data-aos-delay="200"> {{ $dba->mahasiswa }} </h1>
            </div>
            <div class="col-lg-4 col-4 text-center">
                <h4 data-aos="fade-up">Dosen</h4>
                <h1 class="mb-1" data-aos="fade-up" data-aos-delay="200"> {{ $dba->dosen }} </h1>
            </div> <br><br> <br><br><br><br><br><br>
        </div>
        <div class="row">
            <div class="col-lg-6 col-6 text-center">
                <h4 data-aos="fade-up">UKM</h4>
                <h1 class="mb-1" data-aos="fade-up" data-aos-delay="200">{{ $dba->ukm }} </h1>
            </div>
            <div class="col-lg-6 col-6 text-center">
                <h4 data-aos="fade-up">Himpunan</h4>
                <h1 class="mb-1" data-aos="fade-up" data-aos-delay="200"> {{ $dba->himpunan }} </h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="class-thumb text-center" data-aos="fade-up">
            <div class="class-info" style="height: auto">
                <a href="/statdiary/{{ $db->id }}/detaildatabase">
                    <h2>{{ $db->judul }}</h2>
                </a>
            </div>
        </div>
