    ...
    <div class="container">
        <div class="row">
            ...
            <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                ...
                <p data-aos="fade-up" data-aos-delay="500">Mau tau lebih tentang kami? <a rel="nofollow" href="https://instagram.com/bemsv.birostat" target="_parent">Klik disini</a></p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                <div class="class-thumb">
                    <img src="/uploads/statisticdiary/{{ $struktur1->foto }}" class="img-fluid" alt="Class" style="width:d;height:500px;object-fit: cover">
            ...
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                <div class="class-thumb">
                    <img src="/uploads/statisticdiary/{{ $struktur2->foto }}" class="img-fluid" alt="Class" style="width:d;height:500px;object-fit: cover">
                    <div class="class-info" style="height: auto">
            ...
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                <div class="class-thumb">
                    <img src="/uploads/statisticdiary/{{ $struktur3->foto }}" class="img-fluid" alt="Class" style="width:d;height:500px;object-fit: cover">
                    <div class="class-info" style="height: auto">
            ...
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                <div class="class-thumb">
                    <img src="/uploads/statisticdiary/{{ $row->foto }}" class="img-fluid" alt="Class" style="width:d;height:500px;object-fit: cover">
                    <div class="class-info" style="height: auto">
