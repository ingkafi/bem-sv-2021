    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-12 text-center">
                ...
                <h1 data-aos="fade-up" data-aos-delay="200">judul survei</h1>
            </div>
            <div class="col-lg-12 col-12 text-center" style="margin-bottom: 5%;">
                <!-- isi diganti isi database -->
                <h5 data-aos="fade-up" data-aos-delay="200">isi</h5>
            </div>
            <br>
            <br>
            <div class="col-lg-12 col-12">
                <div class="embed-responsive embed-responsive-1by1">
                    ...
                    <?php $str = "https://drive.google.com/file/d/15jp0vMLbLoFfQaGMBeFiFfsGqKgUInKJ/view?usp=sharing" ?>
