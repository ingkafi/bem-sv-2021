                                ...
                                <div class="carousel-item active">
                                    <div class="col-md-4">
                                        <div class="card card-body" style="height: 550px">
                                            ...
                                            <img class="img-fluid" alt="100%x280" style="height: 300px; width:300px;object-fit: cover;" src="{{ asset('uploads/buletin/' . $buletin1->gambar) }}">
                                            <?php
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">{{ date('j', strtotime($buletin1->created_at)) }}
                                                    {{ $monthName }}
                                                    {{ date('Y', strtotime($buletin1->created_at)) }}
                                                </p>
                                                <p data-aos="fade-up" data-aos-delay="50">
                                                    {{ substr($buletin1->isi, 0, 50) }}....
                                                </p>
                                                <a href="/statdiary/{{ $buletin1->id }}/detailbicaradata" class="card-text">Baca
                                                    Selengkapnya</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="carousel-item">
                                    <div class="col-md-4">
                                        <div class="card card-body" style="height: 550px">
                                            ...
                                            <img class="img-fluid" alt="100%x280" style="height: 300px; width:300px;object-fit: cover;" src="{{ asset('uploads/buletin/' . $row->gambar) }}">
                                            <?php
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="/statdiary/{{ $row->id }}/detailbicaradata" class="card-text">Baca
                                                    Selengkapnya</a>
                                            </div>
                                        </div>
                                    </div>
