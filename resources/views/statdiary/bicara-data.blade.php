    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-10 mx-auto col-12 text-center" data-aos="fade-up" data-aos-delay="400">
                <br>
                <p style="color : white;"><i>- tidak ada bicara data - </i></p>
            </div>
            }
            @else{
            <div class="col-lg-8 col-md-10 mx-auto col-12" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="class-thumb">
                    <img src="{{ asset('uploads/buletin/' . $buletin1->gambar) }}" class="img-fluid" alt="Class" style="width:1000px;height:300px;object-fit: cover">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
                <div class="class-thumb">
                    <img src="{{ asset('uploads/buletin/' . $row->gambar) }}" class="img-fluid" alt="Class" style="width:400px;height:300px;object-fit: cover">
                    <div class="class-info" style="height: auto">
                        ...
                        <p data-aos="fade-up" data-aos-delay="150">
                            <a rel="nofollow" href="/statdiary/{{ $row->id }}/detailbicaradata">Baca
                                selengkapnya</a>
                        </p>
                    </div>
                </div>
